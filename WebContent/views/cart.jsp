			...
			<div class="basket-product">
				<div class="item">
					<div class="product-image">
						<img src="../view/${items.item_no}.jpg" alt="item"
							class="product-frame">
					</div>
					<div class="product-details">
						<h1>
							<strong>item:${items.item_no}</strong>
						</h1>
						<p>Size：${items.item_size}</p>
						<p>Color：${items.color}</p>
					</div>
				</div>
				<div class="price">${items.price}yen</div>
				<div class="quantity">
					<input type="number" value="" min="1" class="quantity-field">
				</div>
				<div class="subtotal">${items.price*quantity}yen</div>
				<div class="remove">
