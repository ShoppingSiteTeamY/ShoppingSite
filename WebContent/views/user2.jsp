    ...
    <header>
        ...
        <div class="header-logo">
           ...
           <div class="header-left" style="display:inline-flex">
	             ...
	             <form action="../src/ranking" method="post"><a href=# class="sub" id="W">RANKING</a></form>
	             <form action="../src/lowPrice" method="post"><a href=# class="sub" id="A">LOW PRICE</a></form>
	             <form action="../src/highPrice" method="post"><a href=# class="sub" id="C">HIGH PRICE</a></form>
      ...
      <div class="container" id="con">
        ...
        <div class="top-wrapper">
          ...
          <div class="sub-title">・・YOU CAN CHOOSE ALL OF THEM・・</div>
			...
			<c:forEach var="item" items="${itemBean}" begin="20" end="39">
