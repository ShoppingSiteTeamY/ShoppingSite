...
.main {
	...
	width: auto;
	height: 850px;
	background-image: url(../views/image/back7.jpg);
...
<div class="main">
	...
	<header>
		...
		<div class="header-logo">
			...
			<div class="header-left">商品情報削除画面(必須*) </div>
	...
	<div class="container">
		...
		<form action="../src/deleteSearch" method="post"
			class="form">

			<div class="input-wrapper">

				<!-- <p>商品番号</p> -->
				<input type = "text" class ="click btn-gradation3" name="itemNo" placeholder="商品番号(*)" >
